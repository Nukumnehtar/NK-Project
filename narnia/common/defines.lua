...
NDiplomacy = {
	...
	VASSAL_BASE_LIMIT = 2,					-- Base Vassal Limit
	...
	MAX_DIPLO_DISTANCE = 1200,									-- Most diplomacy is disallowed if two rulers are too distant
	MAX_DIPLO_DISTANCE_SAME_RELIGION = 300,						-- Bonus to max diplo distance for being of the same religion
	MAX_DIPLO_DISTANCE_SAME_RELIGION_GROUP = 100, 				-- Bonus to max diplo distance for being of the same religion group
	MAX_DIPLO_DISTANCE_SAME_CULTURE = 300, 						-- Bonus to max diplo distance for being of the same culture
...
NMilitary = {
	...
	OWN_SETTLEMENT_SUPPLY_BONUS = 1,				-- Extra supply from being in home realm
	NEUTRAL_SETTLEMENT_SUPPLY_BONUS = 0.5,			-- Neutral supply bonus
	CONTROL_SETTLEMENT_SUPPLY_BONUS = 0.5,			-- Supply bonus from occupied settlements
	ENEMY_SETTLEMENT_SUPPLY_BONUS = -0.05,			-- Supply bonus from enemy settlements(woot!)
	HOSTILE_RELIGION_SUPPLY_MOD = -0.5,			-- Supply modifier from a hostile religion
	...
	SUPPLY_CAPACITY = 70,						-- Amount of days of worth supply that a unit can hold.
